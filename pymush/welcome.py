...
instructions2 = (
    ansi_fun("hw", "create <username> <password>") + " creates a new Account.\n"
)
instructions3 = (
    "Enclose multi-word names in quotations. Example: "
...
message = (
    logo + line + instructions + instructions2 + instructions3 + instructions4 + line
)
